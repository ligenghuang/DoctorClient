...
public class CusviewXPopup {
    ...
    public static class Builder {
        ...
        public CusviewXPopup.Builder popupType(PopupType popupType) {
         ...
         * @return
         */
        public CusviewXPopup.Builder dismissOnBackPressed(Boolean isDismissOnBackPressed) {
         ...
         * @return
         */
        public CusviewXPopup.Builder dismissOnTouchOutside(Boolean isDismissOnTouchOutside) {
         ...
         * @return
         */
        public CusviewXPopup.Builder autoDismiss(Boolean autoDismiss) {
         ...
         * @return
         */
        public CusviewXPopup.Builder hasShadowBg(Boolean hasShadowBg) {
         ...
         * @return
         */
        public CusviewXPopup.Builder atView(View atView) {
         ...
         * @return
         */
        public CusviewXPopup.Builder watchView(View watchView) {
         ...
         * @return
         */
        public CusviewXPopup.Builder popupAnimation(PopupAnimation popupAnimation) {
         ...
         * @return
         */
        public CusviewXPopup.Builder customAnimator(PopupAnimator customAnimator) {
         ...
         * @return
         */
        public CusviewXPopup.Builder maxWidth(int maxWidth) {
         ...
         * @return
         */
        public CusviewXPopup.Builder maxHeight(int maxHeight) {
         ...
         * @return
         */
        public CusviewXPopup.Builder autoOpenSoftInput(Boolean autoOpenSoftInput) {
         ...
         * @return
         */
        public CusviewXPopup.Builder moveUpToKeyboard(Boolean isMoveUpToKeyboard) {
         ...
         * @return
         */
        public CusviewXPopup.Builder popupPosition(PopupPosition popupPosition) {
         ...
         * @return
         */
        public CusviewXPopup.Builder hasStatusBarShadow(boolean hasStatusBarShadow) {
         ...
         * @return
         */
        public CusviewXPopup.Builder offsetX(int offsetX) {
         ...
         * @return
         */
        public CusviewXPopup.Builder offsetY(int offsetY) {
         ...
         * @return
         */
        public CusviewXPopup.Builder enableDrag(boolean enableDrag) {
         ...
         * @return
         */
        public CusviewXPopup.Builder isCenterHorizontal(boolean isCenterHorizontal) {
         ...
         * @return
         */
        public CusviewXPopup.Builder isRequestFocus(boolean isRequestFocus) {
...
//        }
         ...
         * @return
         */
        public CusviewXPopup.Builder setPopupCallback(XPopupCallback xPopupCallback) {
         ...
         * @return
         */
        public CusviewAttachListPopupView asAttachList(String[] data, int[] iconIds, int offsetX, int offsetY, OnSelectListener selectListener) {
            popupType(PopupType.AttachView);
            CusviewAttachListPopupView popupView = new CusviewAttachListPopupView(this.context)
        ...
        public CusviewAttachListPopupView asAttachList(String[] data, int[] iconIds, OnSelectListener selectListener) {
