...
*/
public class PrescriptionAction extends BaseAction<PrescriptionView> {
    public PrescriptionAction(RxAppCompatActivity _rxAppCompatActivity, PrescriptionView view) {
    ...
    public void updateDiagnosis(String iuid,String diagonsis){
        post(WebUrlUtil.POST_UPDATEDIAGNOSIS,false,service -> manager.runHttp(
                service.PostData_1(MySharedPreferencesUtil.getSessionId(MyApplication.getContext()),
                        CollectionsUtils.generateMap("iuid",iuid,"diagonsis",diagonsis),WebUrlUtil.POST_UPDATEDIAGNOSIS)
        ));
    }
