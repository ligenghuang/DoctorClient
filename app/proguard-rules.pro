...
-keep public class com.lgh.huanglib.R$*{
    public static final int *;
}


-keep class com.lgh.huanglib.**{*;}
#-dontwarn com.lgh.huanglib.**
...
-keep class com.ruffian.**{*;}
-dontwarn com.ruffian.**
...
-dontwarn com.omesoft.util.calculate.**
-keep class com.omesoft.util.calculate.** { *; }
...
-keep class com.feijin.smarttraining.model.** { *; }#实体类
